...
By default, Keycloak uses Gelf version `1.1`. If you need to use version 1.0 instead, run the following command:

<@kc.start parameters="--log=console,gelf --log-gelf-version=1.0"/>
