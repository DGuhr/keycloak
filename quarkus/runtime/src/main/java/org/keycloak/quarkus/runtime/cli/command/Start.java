...
@Command(name = Start.NAME,
        ...
        footer = "%nBy default, this command tries to update the server configuration by running a '" + Build.NAME + "' before starting the server. You can disable this behavior by using the '" + Start.NO_BUILD_OPTION_LONG + "' option:%n%n"
                + "      $ ${PARENT-COMMAND-FULL-NAME:-$PARENTCOMMAND} ${COMMAND-NAME} '" + Start.NO_BUILD_OPTION_LONG + "'%n%n"
...
public final class Start extends AbstractStartCommand implements Runnable {
    ...
    @CommandLine.Option(names = {NO_BUILD_OPTION_LONG},
