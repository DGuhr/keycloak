...
public abstract class BasicDatabaseTest {
    ...
    @Test
    @Launch({ "start", AbstractStartCommand.NO_BUILD_OPTION_LONG, "--http-enabled=true", "--hostname-strict=false" })
    ...
    @Test
    @Launch({ "start", AbstractStartCommand.NO_BUILD_OPTION_LONG,"--http-enabled=true", "--hostname-strict=false", "--db-username=wrong" })
    ...
    @Test
    @Launch({ "start", AbstractStartCommand.NO_BUILD_OPTION_LONG,"--http-enabled=true", "--hostname-strict=false", "--db-password=wrong" })
